...
export default function ConnectGoogleButton({ isConnected }: { isConnected: boolean }) {
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg bg-card">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Connect Analytics & Search Console</p>
                    </div>
                </div>
                <Button
